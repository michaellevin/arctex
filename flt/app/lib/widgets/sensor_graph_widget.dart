...
class _SensorDataWidgetState extends State<SensorDataWidget> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SensorBloc, SensorState>(builder: (context, state) {
      ...
      return SfCartesianChart(
          ...
          primaryYAxis:
              NumericAxis(title: AxisTitle(text: 'Потеря металла, мм')),
          ...
          series: <ChartSeries>[
            LineSeries<SensorDataModel, DateTime>(
              ...
              yValueMapper: (SensorDataModel sensorData, _) =>
                  sensorData.thickness,
            ),
            LineSeries<SensorDataModel, DateTime>(
                dataSource: state.sensorData,
                xValueMapper: (SensorDataModel sensorData, _) =>
                    sensorData.date,
                yValueMapper: (SensorDataModel sensorData, _) =>
